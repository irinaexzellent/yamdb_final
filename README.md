...
Приложение взято из проекта [https://github.com/irinaexzellent/api_final_yatube](https://github.com/irinaexzellent/api_yamdb), который представляет собой API сервиса отзывов о фильмах, книгах и музыке.
